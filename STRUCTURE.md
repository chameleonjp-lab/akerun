...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `components/GameCanvas.tsx` | React のライフサイクル内で native Canvas 2D コンテキストを一度だけ取得し、リサイズと破棄を管理する。                                                                                                                |
| `game/scene.ts`             | `VaultWorld` を生成し、フレーム例外を隔離して更新を委譲する。                                                                                                                                                       |
